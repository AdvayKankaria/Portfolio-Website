...
/**
 * Sourced from 21st.dev (designali-in/liquid-glass-button). Kept available as a
 * library primitive. NOTE: the canonical CTA in this project is
 * `components/atoms/Button.tsx` (the 3-variant Graphite Mono + Red system).
 * These glass/metal variants use gradients that fall outside that system, so
 * they are intentionally not used in the portfolio chrome — they exist only as
 * an opt-in extra per the integration request.
 */
